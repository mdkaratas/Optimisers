# -*- coding: utf-8 -*-
"""
Created on Tue Feb  9 03:00:52 2021
...
fig = make_subplots(rows=1, cols=2,specs=[[{"type": "surface"}, {"type": "scatter3d"}]],
                                          horizontal_spacing = 0.001,vertical_spacing=0.05, subplot_titles=("3-D Landscape visualisation", "LON constructed with p = 0.05"))
...
node_sz = [v.shape[0]*0.5 for k,v in st.items()] 
...
fig.update_layout(height=1100, width=1100, title_text="Subplots with Annotations")
