...
# store I
with open("Desktop/x_CMA_MI_P_2.txt", "wb") as fp:   #Pickling
    pickle.dump(X, fp)   
with open("Desktop/x_CMA_MI_P_2.txt", "rb") as fp:   # Unpickling
    x_CMA_MI_P_2 = pickle.load(fp)
...
# store init F    
with open("Desktop/f_CMA_MI_P_2.txt", "wb") as fp:   #Pickling
    pickle.dump(F, fp)   
with open("Desktop/f_CMA_MI_P_2.txt", "rb") as fp:   # Unpickling
