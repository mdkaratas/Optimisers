...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 23 14:31:24 2021
...
for i in range(30):
    ...
    local_fit = []
    def main():
        number_of_fitness_evaluations = 5*10**5
...
with open("design_dict_NMMSO_MI.txt", "wb") as fp:   
    pickle.dump(design_dict, fp)   
with open("Desktop/design_dict_NMMSO_MI.txt", "rb") as fp:   
    design_dict_NMMSO_MI = pickle.load(fp)  

with open("Desktop/fit_dict_NMMSO_MI.txt", "wb") as fp:   
    pickle.dump(fit_dict, fp)   
with open("Desktop/fit_dict_NMMSO_MI.txt", "rb") as fp:   
