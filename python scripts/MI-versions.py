...
# inputparams = [4.46,6.27, 10.43,0.38, 0.59,0.5,0,5]
...
fig,(ax,ax2) = plt.subplots(1,2,sharex='col',dpi= 100)
data = [f_g1, f_g3, f_g0, f_g2]
#ax = fig.add_axes([0, 0, 1, 1])
...
data = [gate_1, gate_3, gate_2,gate_0]
fig = plt.figure(figsize =(7, 6))
...
class MyProblem:
  ...
  def get_bounds():
    ...
    def main():
        number_of_fitness_evaluations = 5e+2
...
a = ax.plot(x,gate_1x[0],x,gate_1x[1]x,gate_1x[2],x,gate_1x[3],x,gate_1x[4],x,gate_1x[5],x,gate_1x[6],x,gate_1x[7],x,gate_1x[8],x,gate_1x[9],x,gate_1x[10])
b = ax2.plot(x,gate_1x[0],x,gate_1x[1]x,gate_1x[2],x,gate_1x[3],x,gate_1x[4],x,gate_1x[5],x,gate_1x[6],x,gate_1x[7],x,gate_1x[8],x,gate_1x[9],x,gate_1x[10])
c = ax3.plot(x,gate_1x[0],x,gate_1x[1]x,gate_1x[2],x,gate_1x[3],x,gate_1x[4],x,gate_1x[5],x,gate_1x[6],x,gate_1x[7],x,gate_1x[8],x,gate_1x[9],x,gate_1x[10])
d = ax4.plot(x,gate_1x[0],x,gate_1x[1]x,gate_1x[0],x,gate_1x[0],x,gate_1x[0],x,gate_1x[0],x,gate_1x[0],x,gate_1x[0],x,gate_1x[0],x,gate_1x[0],)
#e = ax5.plot(x,gate_0x[0],x,gate_0x[1])
