...
# store I
with open("Desktop/x_CMA_MI_P_3.txt", "wb") as fp:   #Pickling
    pickle.dump(X, fp)   
with open("Desktop/x_CMA_MI_P_3.txt", "rb") as fp:   # Unpickling
    x_CMA_MI_P_3 = pickle.load(fp)
...
# store init F    
with open("Desktop/f_CMA_MI_P_3.txt", "wb") as fp:   #Pickling
    pickle.dump(F, fp)   
with open("Desktop/f_CMA_MI_P_3.txt", "rb") as fp:   # Unpickling
