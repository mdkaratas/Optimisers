...
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/design_dict_NMMSO_MI.txt", "rb") as fp:   
    design_dict_NMMSO_MI = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/fit_dict_NMMSO_MI.txt", "rb") as fp:   
    fit_dict_NMMSO_MI = pickle.load(fp)
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/x_NMMSO_MI.txt", "rb") as fp:   
    x_NMMSO_MI = pickle.load(fp)      
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/f_NMMSO_MI.txt", "rb") as fp:   
    f_NMMSO_MI  = pickle.load(fp)         
    
#############################################  NMMSO 01 without penalty

with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/design_dict_NMMSO1.txt", "rb") as fp:   
    design_dict_NMMSO1 = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/fit_dict_NMMSO1.txt", "rb") as fp:   
    fit_dict_NMMSO1 = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/x_NMMSO_1.txt", "rb") as fp:   
    x_NMMSO_1 = pickle.load(fp)      
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/f_NMMSO_1.txt", "rb") as fp:   
    f_NMMSO_1 = pickle.load(fp)  
    
      
#############################################  NMMSO 10 without penalty

with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/design_dict_NMMSO2.txt", "rb") as fp:   
    design_dict_NMMSO2 = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/fit_dict_NMMSO2.txt", "rb") as fp:   
    fit_dict_NMMSO2  = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/x_NMMSO_2.txt", "rb") as fp:   
    x_NMMSO_2 = pickle.load(fp)      
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/f_NMMSO_2.txt", "rb") as fp:   
    f_NMMSO_2 = pickle.load(fp)  


#############################################  NMMSO 11 without penalty

with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/design_dict_NMMSO3.txt", "rb") as fp:   
    design_dict_NMMSO3 = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/fit_dict_NMMSO3.txt", "rb") as fp:   
    fit_dict_NMMSO3 = pickle.load(fp)      
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/x_NMMSO_3.txt", "rb") as fp:   
    x_NMMSO_3 = pickle.load(fp)     
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/f_NMMSO_3.txt", "rb") as fp:   
    f_NMMSO_3 = pickle.load(fp)      

#############################################  NMMSO 00 without penalty


with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/design_dict_NMMSO0.txt", "rb") as fp:   
    design_dict_NMMSO0 = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/fit_dict_NMMSO0.txt", "rb") as fp:   
    fit_dict_NMMSO0 = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/x_NMMSO_0.txt", "rb") as fp:   
    x_NMMSO_0 = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/f_NMMSO_0.txt", "rb") as fp:   
...
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/design_dict_NMMSO_MI_P.txt", "rb") as fp:   
    design_dict_NMMSO_MI_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/fit_dict_NMMSO_MI_P.txt", "rb") as fp:   
    fit_dict_NMMSO_MI_P = pickle.load(fp)       
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/x_NMMSO_MI_P.txt", "rb") as fp:   
    x_NMMSO_MI_P = pickle.load(fp) 
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/f_NMMSO_MI_P.txt", "rb") as fp:   
...
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/design_dict_NMMSO1_P.txt", "rb") as fp:   
    design_dict_NMMSO1_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/NMMSO/fit_dict_NMMSO1.txt", "rb") as fp:   
    fit_dict_NMMSO1_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/x_NMMSO1_P.txt", "rb") as fp:   
    x_NMMSO_1_P = pickle.load(fp)      
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/f_NMMSO1_P.txt", "rb") as fp:   
    f_NMMSO_1_P = pickle.load(fp)  

#############################################  NMMSO 10 with Penalty

with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/design_dict_NMMSO2_P.txt", "rb") as fp:   
    design_dict_NMMSO2_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/fit_dict_NMMSO2_P.txt", "rb") as fp:   
    fit_dict_NMMSO2_P  = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/x_NMMSO2_P.txt", "rb") as fp:   
    x_NMMSO_2_P = pickle.load(fp)      
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/f_NMMSO2_P.txt", "rb") as fp:   
...
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/design_dict_NMMSO3_P.txt", "rb") as fp:   
    design_dict_NMMSO3_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/fit_dict_NMMSO3_P.txt", "rb") as fp:   
    fit_dict_NMMSO3_P = pickle.load(fp)      
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/x_NMMSO3_P.txt", "rb") as fp:   
    x_NMMSO_3_P = pickle.load(fp)     
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/f_NMMSO3_P.txt", "rb") as fp:   
    f_NMMSO_3_P = pickle.load(fp)        
    
#############################################  NMMSO 00 with Penalty

with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/design_dict_NMMSO0_P.txt", "rb") as fp:   
    design_dict_NMMSO0_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/fit_dict_NMMSO0_P.txt", "rb") as fp:   
    fit_dict_NMMSO0_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/x_NMMSO0_P.txt", "rb") as fp:   
    x_NMMSO_0_P = pickle.load(fp)  
with open("Desktop/Llyonesse/Neuro_1lp_res/penalty_results/nmmso-p/gates_penalty/f_NMMSO0_P.txt", "rb") as fp:   
...
allf = []
for i in range(len(f_pairs)):
    allf.append(min(f_pairs[i]))    
   


b = [[(x-min(allf))/(max(allf)-min(allf)) for x in l] for l in f_pairs]
f_pairs = b
...
n = 30
fig = plt.figure(figsize=(3,3),dpi=5000,facecolor='white')   #g, axes = plt.subplots(nrows=30, ncols=30,figsize=(10,10))
gs = fig.add_gridspec(nrows=n, ncols=n)
ax = np.zeros((n, n), dtype=object)
for i in range(n):
    for j in range(0+i,n):
...
comb = list(zip(x_NMMSO_1_P,f_NMMSO_1_P))
sorted_list = sorted(comb, key=lambda x: x[1])
xlist = []
flist =[]
for i in sorted_list:
...
with open("Desktop/Llyonesse//Neuro_1lp_res/f_pairs_NMMSO.txt", "wb") as fp:   
    pickle.dump(f_pairs, fp)  
with open("Desktop/Llyonesse//Neuro_1lp_res/f_pairs_NMMSO.txt", "rb") as fp:   
    f_pairs = pickle.load(fp)  
...
gate_1 =[] 
gate_1.append(x_NMMSO_1_P[13]) 
gate_1.append(x_NMMSO_1_P[17])


fn = []
fn.append(f_NMMSO_1_P[13])
fn.append(f_NMMSO_1_P[17])
f = fn
...
for i in range(len(f_NMMSO_1_P[13])):
    if f_NMMSO_1_P[13][i]==f[f.index(f_NMMSO_1_P[13][i])]:
        c1.append(colours[f.index(f_NMMSO_1_P[13][i])])
for i in range(len(f_NMMSO_1_P[17])):        
    if f_NMMSO_1_P[17][i]==f[f.index(f_NMMSO_1_P[17])]:
        c2.append(colours[f.index(f_NMMSO_1_P[17][i])])  
