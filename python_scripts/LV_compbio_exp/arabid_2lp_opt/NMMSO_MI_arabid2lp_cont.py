...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  2 22:27:55 2022
...
with open("Desktop/design_dict_NMMSO_MI_cts_arabid2lp.txt", "wb") as fp:   
    pickle.dump(design_dict, fp)   
with open("Desktop/design_dict_NMMSO_MI_cts_arabid2lp.txt", "rb") as fp:   
    design_dict_NMMSO_MI_P = pickle.load(fp)  

with open("Desktop/fit_dict_NMMSO_MI_cts_arabid2lp.txt", "wb") as fp:   
    pickle.dump(fit_dict, fp)   
with open("Desktop/fit_dict_NMMSO_MI_cts_arabid2lp..txt", "rb") as fp:   
    fit_dict_NMMSO_MI_P = pickle.load(fp)     
    

with open("Desktop/x_NMMSO_MI_cts_arabid2lp.txt", "wb") as fp:   #Pickling
    pickle.dump(x_NMMSO_MI, fp)   
with open("Desktop/x_NMMSO_MI_cts_arabid2lp.txt", "rb") as fp:   # Unpickling
    x_NMMSO_MI_P = pickle.load(fp)


with open("Desktop/f_NMMSO_MI_cts_arabid2lp.txt", "wb") as fp:   #Pickling
    pickle.dump(f_NMMSO_MI, fp)   
with open("Desktop/f_NMMSO_MI_cts_arabid2lp.txt", "rb") as fp:   # Unpickling
