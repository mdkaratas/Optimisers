...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 31 01:07:19 2022
...
for k in range(152,153):
    ...
    # store X
    with open(f"Desktop/x_CMAES_{savename}_cts.txt", "wb") as fp:   #Pickling
        pickle.dump(x_CMA_1, fp)   
    with open(f"Desktop/x_CMAES_{savename}_cts.txt", "rb") as fp:   # Unpickling
        x_CMA_1 = pickle.load(fp)
    
    with open(f"Desktop/f_CMAES_{savename}_cts.txt", "wb") as fp:   #Pickling
        pickle.dump(f_CMA_1 , fp)   
    with open(f"Desktop/f_CMAES_{savename}_cts.txt", "rb") as fp:   # Unpickling
