...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 30 17:06:22 2022
...
with open(f"Desktop/x_CMAES_MI_cts.txt", "wb") as fp:   #Pickling
 pickle.dump(X, fp)   
with open(f"Desktop/x_CMAES_MI_cts.txt", "rb") as fp:   # Unpickling
 X = pickle.load(fp)

F = [] 
for i in X:
    F.append(-1*neuro2lp(i))   
# store init F    
with open(f"Desktop/f_CMAES_MI_cts.txt", "wb") as fp:   #Pickling
 pickle.dump(F, fp)   
with open(f"Desktop/f_CMAES_MI_cts.txt", "rb") as fp:   # Unpickling
