...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 10:50:27 2022
...
while c<1000:
    ...
    if neuro2lp_gates([x,y,z,t,u,v,p,w])<=6:
        init_sol.append([x,y,z,t,u,v,p,w] ) 
        domain.append(neuro2lp_gates([x,y,z,t,u,v,p,w]))
        c = c +1
...
###############################################  Data save
with open(f"Desktop/xt_8dim_2lp.txt", "wb") as fp:   
  pickle.dump(init_sol, fp)  
with open(f"Desktop/xt_8dim_2lp.txt", "rb") as fp:   
 init_sol = pickle.load(fp)   

with open(f"Desktop/yt_8dim_2lp.txt", "wb") as fp:   
  pickle.dump(domain, fp)  
with open(f"Desktop/yt_8dim_2lp.txt", "rb") as fp:   
...
plt.plot(x_test,pred,'bo',label ='predictions')
plt.xlabel("Test data")
plt.ylabel("Predictions")
plt.axis('equal')
plt.xlim([-0.01, 1.1])
plt.ylim([-0.01, 1.1]) 
plt.title("neuro2lp spora", fontsize=10) 
plt.show()
